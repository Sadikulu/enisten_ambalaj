...
import com.kss.dto.OrderItemDTO;
import com.kss.dto.request.OrderItemQuantityUpdateRequest;
import com.kss.dto.request.OrderRequest;
import com.kss.dto.request.OrderUpdateProduct;
...
import com.kss.mapper.OrderItemMapper;
import com.kss.mapper.OrderMapper;
import com.kss.repository.*;
...
public class OrderService {
    ...
    public OrderDTO createOrder(String cartUUID, OrderRequest orderRequest) {
        ...
        double grandTotal = Double.parseDouble(df.format(grandTotalCalculator(subTotal,discount,tax,orderCoupon)).replaceAll(",","."));
    ...
    private double grandTotalCalculator(double subTotal,double discount, double tax, OrderCoupon orderCoupon) {
    ...
    public OrderDTO updateOrder(OrderUpdateRequest orderUpdateRequest) {
        ...
        double updatedOrderGrandTotal = Double.parseDouble(df.format(grandTotalCalculator(newOrderListSubTotal,newDiscountedPrice,newTaxPrice,orderCoupon)).replaceAll(",","."));
